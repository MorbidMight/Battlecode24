...
import static Version18Final.RobotPlayer.lowestHealth;
import static Version18Final.RobotPlayer.targetLoc;
import static Version18Final.Utilities.averageRobotLocation;
import static Version18Final.Utilities.bestHeal;
...
public class OffensiveBuilder {
    ...
    public static void runOffensiveBuilder(RobotController rc) throws GameActionException {
        ...
        if(enemyRobots.length > 0)
            ...
            if(targetLoc == null)
                targetLoc = Utilities.getClosestCluster(rc).location;
            if(targetLoc == null)
